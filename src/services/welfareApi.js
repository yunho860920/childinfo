...
function getNationalRoadmapContent() {
  return [
    ...
    },
    {
      ...
      details: {
        target: '2024년 이후 출생아',
        content: '둘째 아이부터 300만원으로 상향됨. 국민행복카드 포인트로 지급하며 1년 내 사용 필수',
        how: '복지로 또는 주민센터 신청',
      },
    ...
    },
    {
      ...
      desc: '0세 월 120만원 / 1세 월 60만원 현금 지급',
      tags: ['매월 현금', '2025년 인상'],
      details: {
        target: '만 2세 미만 영아를 양육하는 부모',
        content: '2025년부터 0세 월 120만원, 1세 월 60만원 지급 (어린이집 이용 시 보육료 차감 후 잔액 지급)',
        how: '복지로 신청 또는 주민센터 방문',
      },
      link: 'https://www.bokjiro.go.kr',
    },
    ...
    },
    {
      id: 'nat_7',
      stage: 3,
      title: '육아휴직 급여 인상 (2025)',
      desc: '첫 3개월 월 최대 250만원 지원 (사후지급금 폐지)',
      tags: ['육아휴직', '2025년 개편'],
      details: {
        target: '고용보험 가입 근로자',
        content: '1~3개월 250만원 / 4~6개월 200만원 / 7개월 이후 160만원. 복직 후 지급하던 25% 사후지급금이 폐지되어 휴직 중 전액 수령 가능',
        how: '고용보험 홈페이지 신청',
      },
      link: 'https://www.ei.go.kr',
    },
    ...
    // ── Stage 4: 성장 가속 (4~12개월) ──────────
    {
      ...
      desc: '매월 10만원 지급, 2026년부터 만 9세까지 확대',
      tags: ['매월 현금', '2026년 확대'],
      details: {
        target: '대한민국 모든 아동 (2026년부터 만 9세 미만)',
        content: '기존 만 8세 미만에서 만 9세 미만으로 대상 연령 확대 추진 중. 소득 무관 월 10만원 지급',
        how: '복지로 온라인 신청',
      },
      link: 'https://www.bokjiro.go.kr',
    },
    ...
    '대전': [
      {
        ...
        subRegion: '전체',
        stage: 2,
        title: '대전형 부모급여 (대전형 양육수당)',
        desc: '정부 부모급여에 더해 월 30만원 추가 현금 지급',
        tags: ['대전시 전용', '월 30만원'],
        details: {
          target: '대전시 거주 0~2세 영유아 부모',
          content: '정부 부모급여와 별개로 대전시에서 월 30만원을 추가로 현금 지급 (소득 무관)',
          how: '거주지 행정복지센터 방문 신청',
        },

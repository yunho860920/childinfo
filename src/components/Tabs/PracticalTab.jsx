...
const PracticalTab = ({ childInfo, selectedTimelineMonth, setSelectedTimelineMonth }) => {
  ...
  const categories = [
    ...
    { id: '놀아주는 법', icon: <Sparkles size={16} /> },
    { id: '이유식 영양 가이드', icon: <Utensils size={16} /> }
  ];
  ...
  const getCategoryColor = (cat) => {
    switch (cat) {
      ...
      case '놀아주는 법': return 'from-pink-500/20 to-rose-500/20 text-pink-600 dark:text-pink-400 border-pink-100 dark:border-pink-500/20';
      case '이유식 영양 가이드': return 'from-orange-500/20 to-rose-500/20 text-rose-600 dark:text-rose-400 border-rose-100 dark:border-rose-500/20';
  ...
  const getCategoryIcon = (cat) => {
    switch (cat) {
      ...
      case '놀아주는 법': return <Sparkles size={18} />;
      case '이유식 영양 가이드': return <Utensils size={18} />;
